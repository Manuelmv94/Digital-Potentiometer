...
#define SPI_CLOCK_POL   1              //Choose Clock polarity as Active-High(0) or Active-Low(1)
#define SPI_CLOCK_PHA   1              //Choose the first edge on the clock to occur at the middle(0) or at the start(1) of the transfer         
